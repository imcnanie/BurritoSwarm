...
if("TRUE" STREQUAL "TRUE")
  set(libmavconn_SOURCE_PREFIX /home/bjork/BurritoSwarm/flight_code/ROS/src/mavros/libmavconn)
  set(libmavconn_DEVEL_PREFIX /home/bjork/BurritoSwarm/flight_code/ROS/devel/.private/libmavconn)
  ...
  set(libmavconn_INSTALL_PREFIX /home/bjork/BurritoSwarm/flight_code/ROS/install)
...
if(NOT "/home/bjork/BurritoSwarm/flight_code/ROS/src/mavros/libmavconn/include;/usr/include;/home/bjork/BurritoSwarm/flight_code/ROS/devel/include " STREQUAL " ")
  set(libmavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/bjork/BurritoSwarm/flight_code/ROS/src/mavros/libmavconn/include;/usr/include;/home/bjork/BurritoSwarm/flight_code/ROS/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'libmavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bjork/BurritoSwarm/flight_code/ROS/src/mavros/libmavconn/${idir}'.  Ask the maintainer 'Vladimir Ermakov <vooon341@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bjork/BurritoSwarm/flight_code/ROS/devel/.private/libmavconn/lib;/home/bjork/BurritoSwarm/flight_code/ROS/devel/lib;/opt/ros/jade/lib)
