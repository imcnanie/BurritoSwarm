...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2fh3f.pack(_x.airspeed, _x.groundspeed, _x.heading, _x.throttle, _x.altitude, _x.climb))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.airspeed, _x.groundspeed, _x.heading, _x.throttle, _x.altitude, _x.climb,) = _struct_2fh3f.unpack(str[start:end])
      return self
