...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_6f.pack(_x.monotonic, _x.amsl, _x.local, _x.relative, _x.terrain, _x.bottom_clearance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.monotonic, _x.amsl, _x.local, _x.relative, _x.terrain, _x.bottom_clearance,) = _struct_6f.unpack(str[start:end])
      return self
