...
class ExtendedState(genpy.Message):
  _md5sum = "c2e3721f1a54980a39715b775091885e"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2B.pack(_x.vtol_state, _x.landed_state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.vtol_state, _x.landed_state,) = _struct_2B.unpack(str[start:end])
      return self
