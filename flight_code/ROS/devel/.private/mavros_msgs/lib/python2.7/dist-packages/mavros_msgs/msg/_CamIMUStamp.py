...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2Ii.pack(_x.frame_stamp.secs, _x.frame_stamp.nsecs, _x.frame_seq_id))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.frame_stamp.secs, _x.frame_stamp.nsecs, _x.frame_seq_id,) = _struct_2Ii.unpack(str[start:end])
