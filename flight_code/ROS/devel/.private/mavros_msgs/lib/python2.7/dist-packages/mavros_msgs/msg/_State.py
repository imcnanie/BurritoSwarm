...
class State(genpy.Message):
  _md5sum = "9e3d873fae342c8f48a8bd64c53d991e"
...
"""
  __slots__ = ['header','connected','armed','guided','mode']
  _slot_types = ['std_msgs/Header','bool','bool','bool','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,connected,armed,guided,mode
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3B.pack(_x.connected, _x.armed, _x.guided))
      _x = self.mode
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.connected, _x.armed, _x.guided,) = _struct_3B.unpack(str[start:end])
