...
struct ExtendedState_
{
  ...
  _landed_state_type landed_state;
    ...
    enum { VTOL_STATE_UNDEFINED = 0u };
     enum { VTOL_STATE_TRANSITION_TO_FW = 1u };
     enum { VTOL_STATE_TRANSITION_TO_MC = 2u };
     enum { VTOL_STATE_MC = 3u };
     enum { VTOL_STATE_FW = 4u };
     enum { LANDED_STATE_UNDEFINED = 0u };
     enum { LANDED_STATE_ON_GROUND = 1u };
     enum { LANDED_STATE_IN_AIR = 2u };
...
struct MD5Sum< ::mavros_msgs::ExtendedState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc2e3721f1a54980aULL;
  static const uint64_t static_value2 = 0x39715b775091885eULL;
};
