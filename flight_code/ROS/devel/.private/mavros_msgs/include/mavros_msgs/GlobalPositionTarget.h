...
struct GlobalPositionTarget_
{
  ...
  _yaw_rate_type yaw_rate;
    ...
    enum { FRAME_GLOBAL_INT = 5u };
     enum { FRAME_GLOBAL_REL_ALT = 6u };
     enum { FRAME_GLOBAL_TERRAIN_ALT = 11u };
     enum { IGNORE_LATITUDE = 1u };
     enum { IGNORE_LONGITUDE = 2u };
     enum { IGNORE_ALTITUDE = 4u };
     enum { IGNORE_VX = 8u };
     enum { IGNORE_VY = 16u };
     enum { IGNORE_VZ = 32u };
     enum { IGNORE_AFX = 64u };
     enum { IGNORE_AFY = 128u };
     enum { IGNORE_AFZ = 256u };
     enum { FORCE = 512u };
     enum { IGNORE_YAW = 1024u };
     enum { IGNORE_YAW_RATE = 2048u };
